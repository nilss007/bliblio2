...
public class ProveedoreJpaController implements Serializable {
    ...
    public void create(Proveedore proveedore) {
        ...
        try {
            ...
            for (Producto productoListProducto : proveedore.getProductoList()) {
                Proveedore oldProveedoresIdOfProductoListProducto = productoListProducto.getProveedoresId();
                productoListProducto.setProveedoresId(proveedore);
                productoListProducto = em.merge(productoListProducto);
                if (oldProveedoresIdOfProductoListProducto != null) {
                    oldProveedoresIdOfProductoListProducto.getProductoList().remove(productoListProducto);
                    oldProveedoresIdOfProductoListProducto = em.merge(oldProveedoresIdOfProductoListProducto);
                }
            }
    ...
    public void edit(Proveedore proveedore) throws NonexistentEntityException, Exception {
        ...
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            Proveedore persistentProveedore = em.find(Proveedore.class, proveedore.getId());
            ...
            for (Producto productoListOldProducto : productoListOld) {
                if (!productoListNew.contains(productoListOldProducto)) {
                    productoListOldProducto.setProveedoresId(null);
                    productoListOldProducto = em.merge(productoListOldProducto);
                }
            }
            for (Producto productoListNewProducto : productoListNew) {
                if (!productoListOld.contains(productoListNewProducto)) {
                    Proveedore oldProveedoresIdOfProductoListNewProducto = productoListNewProducto.getProveedoresId();
                    productoListNewProducto.setProveedoresId(proveedore);
                    productoListNewProducto = em.merge(productoListNewProducto);
                    if (oldProveedoresIdOfProductoListNewProducto != null && !oldProveedoresIdOfProductoListNewProducto.equals(proveedore)) {
                        oldProveedoresIdOfProductoListNewProducto.getProductoList().remove(productoListNewProducto);
                        oldProveedoresIdOfProductoListNewProducto = em.merge(oldProveedoresIdOfProductoListNewProducto);
                    }
                }
            }
            em.getTransaction().commit();
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            for (Producto productoListProducto : productoList) {
                productoListProducto.setProveedoresId(null);
                productoListProducto = em.merge(productoListProducto);
            }
