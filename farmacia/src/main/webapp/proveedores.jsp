...
<html>
    ...
    <body>
        ...
        <table border="1">
            ...
            <tr>
                <td><%= item.getIdProveedores() %></td>
                <td><%= item.getNombre() %></td>
                <td><%= item.getDireccion() %></td>
                <td><%= item.getTelefono() %></td>
                <th><a href="ProveedoreServlet?action=edit&id=<%= item.getIdProveedores() %>">Editar</a></th>
                <th><a href="ProveedoreServlet?action=dele&id=<%= item.getIdProveedores() %>" onclick="return (confirm('Esta seguro de eliminar ?'))" >Eliminar</a></th>
            </tr>
            <%
                }
            %>
